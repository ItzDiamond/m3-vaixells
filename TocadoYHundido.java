...
public class TocatAndEnsamblat {
	public static void  omplirRandom (char vTauler [] [], int quantVaixell, int mida) {/*Funció per omplir vTauler de vaixells aleatòriament */
		...
		int i,contPunts=0,posCol,posFil,k=0, direccio;
	...
	public static void main(String[] args) {
		...
		int userFil,userCol,intents=25,enfonsats=0;
		...
		while(intents!=0 && enfonsats!=10) {//itera fins a enfonsar tots els  vaixells o arribar a 25 intents
			mostrar(vTauler);//només per comprobar
			System.out.println("----------------------");
			System.out.println("Tens " + intents + " intents.");
		...
		if(intents==0) {
			System.out.println("Has perdud, noob.");
		}
		else {
			System.out.println("Has guanyat! Er Bichoo.");
		}
		teclat.close();
